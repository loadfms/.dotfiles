...
M.setup = function()
    ...
    local highlights = {
        ...
        ColorColumn = { bg = colors.black_fade },
        ...
        Pmenu = { fg = colors.white, bg = colors.black_fade },
        ...
        NormalFloat = { fg = colors.white, bg = colors.black_fade },
        ...
        DiagnosticWarn = { fg = colors.error, bg = colors.black_fade },
        DiagnosticError = { fg = colors.error, bg = colors.black_fade },
